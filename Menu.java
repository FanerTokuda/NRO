                ...
                if (p.id == 1 && p.name.equals("admin") || p.name.equals("nhtgame") || p.name.equals("berus") || p.name.equals("coldxayda")) {
                    if (p.menuID == -1) {
                        if (select == 0) {
                            ...
                            try {
                                m = new Message(-125);
                                m.writer().writeUTF("NHTGAME BUFF Robux Player");
...
//            }
            case 997: {
                if (p.map.id == 5) {
                    if (p.menuID == -1) {//nhận thỏi vàng ở satan
                        ...
                        if (select == 0) {
                            ...
                            break;
                        } else if (select == 1) {//Nhận thỏi vàng
                            if (p.sotien <= 0) {
                                p.sendAddchatYellow("Bạn không đủ tiền vui lòng nạp thêm");
                                return;
                            }
                            ...
                            p.sendAddchatYellow("Bạn nhận được " + _itemBuff.quantity + " thỏi vàng");
                            break;
                        } else if (select == 2) {// nhận thỏi vàng
                            if (p.sotien <= 0) {
                                p.sendAddchatYellow("Bạn không đủ tiền vui lòng nạp thêm");
                                return;
                            }
                            p.sotien -= 100000;
                            Item _itemBuff = new Item(itemBuff);
                            _itemBuff.quantity = 240;
                            p.addItemToBag(_itemBuff);
                            Service.gI().updateItemBag(p);
                            Service.gI().buyDone(p);
                            p.sendAddchatYellow("Bạn nhận được " + _itemBuff.quantity + " thỏi vàng");
                            break;
                        } else if (select == 3) {//Nhận thỏi vàng
                            if (p.sotien <= 0) {
                                p.sendAddchatYellow("Bạn không đủ tiền vui lòng nạp thêm");
                                return;
                            }
                            ...
                            p.sendAddchatYellow("Bạn nhận được " + _itemBuff.quantity + " thỏi vàng");
                            break;
                        } else if (select == 4) {//Nhận thỏi vàng
                            if (p.sotien <= 0) {
                                p.sendAddchatYellow("Bạn không đủ tiền vui lòng nạp thêm");
                                return;
                            }
                            p.sotien -= 500000;
                            Item _itemBuff = new Item(itemBuff);
                            _itemBuff.quantity = 1200;
                            p.addItemToBag(_itemBuff);
                            Service.gI().updateItemBag(p);
                            Service.gI().buyDone(p);
                            p.sendAddchatYellow("Bạn nhận được " + _itemBuff.quantity + " thỏi vàng");
                            break;
                        } else if (select == 5) {//Nhận thỏi vàng
                            if (p.sotien <= 0) {
                                p.sendAddchatYellow("Bạn không đủ tiền vui lòng nạp thêm");
                                return;
                            }
            ...
            case 996: {
                if (p.map.id == 5) {
                    if (p.menuID == -1) {
                        if (select == 0) {
                            if (p.sotien <= 0) {//Nhận ngọc từ satan
                                p.sendAddchatYellow("Bạn không đủ tiền vui lòng nạp thêm");
                                return;
                            }
                            p.sotien -= 20000;
                            ...
                            break;
                        } else if (select == 1) {//Nhận ngọc từ satan
                            if (p.sotien <= 0) {
                                p.sendAddchatYellow("Bạn không đủ tiền vui lòng nạp thêm");
                                return;
                            }
                            ...
                            p.sendAddchatYellow("Bạn nhận được " + number + " ngọc xanh");
                            break;
                        } else if (select == 2) {//Nhận ngọc từ satan
                            if (p.sotien <= 0) {
                                p.sendAddchatYellow("Bạn không đủ tiền vui lòng nạp thêm");
                                return;
                            }
                            ...
                            p.sendAddchatYellow("Bạn nhận được " + number + " ngọc xanh");
                            break;
                        } else if (select == 4) {//Nhận ngọc từ satan
                            if (p.sotien <= 0) {
                                p.sendAddchatYellow("Bạn không đủ tiền vui lòng nạp thêm");
                                return;
                            }
                            ...
                            p.sendAddchatYellow("Bạn nhận được " + number + " ngọc xanh");
                            break;
                        } else if (select == 5) {//Nhận ngọc từ satan
                            if (p.sotien <= 0) {
                                p.sendAddchatYellow("Bạn không đủ tiền vui lòng nạp thêm");
                                return;
                            }
            ...
            case 54: {//Ly tieu nuong
                if (p.map.id == 5) {
                    if (p.menuID == 0 && select == 0) {
                        if (p.ngoc < 50000) {
                            p.sendAddchatYellow("Vui lòng có ít nhất 50k ngọc để thao tác");
                            return;
                        }
                        if (p.NhapThe == 1) {
                        ...
                        break;
                    } else if (p.menuID == 1 && select == 0) {// MENU SU KIEN
                        //Select sau khi chọn select 1 ban đầu của lý tiểu nương
                        int scl = p.getIndexItemBagByID(516);
                        if (scl != -1 && p.ItemBag[scl].quantity >= 99) {//Check scl hành trang
                            p.ItemBag[scl].quantity -= 99;
                            if (p.ItemBag[scl].quantity <= 0) {
                                p.ItemBag[scl] = null;
                                p.updateItemBag();
                                Service.gI().buyDone(p);
                            }
                            Item itemcsh = ItemSell.getItemNotSell(722);
                            Item _itemcsh = new Item(itemcsh);
                            p.addItemToBag(_itemcsh);
                            p.sendAddchatYellow("Bạn nhận được viên Capsule Hồng");
                            p.updateItemBag();
                            Service.gI().buyDone(p);
                            return;

                        } else {
                            p.sendAddchatYellow("Bạn không đủ thành tâm");
                            return;
                        }
                    }

                    if (select == 1) {//Select ban đầu của lý tiểu nương
                        doMenuArray(p, idNpc, "Đổi vật phẩm sự kiện ", new String[]{"Đổi\n-99 Sôcôla", "Không"});
                        p.menuID = select;
                    }
                    if (select == 0) {
                        if (p.detu == null) {
            ...
            case 49: { //DUONG TANG
                if (p.map.id == 0) {
                    if (p.menuID == -1) {
                        if (select == 0) {
                            if (p.power < 1500000) {
                                p.sendAddchatYellow("Nhà ngươi phải đạt 1,5 Triệu sức mạnh mới có thể cứu được đồ đệ của ta !");
                                return;
                            }
                            GotoMap(p, 123);
                        }
            ...
            case 39: {
                if (p.map.id == 5) {
                    if (p.menuID != -1) {
                        if (p.menuID == 1 && select == 0) {//mo thanh vien
                            Item itemBuff = ItemBuff.getItem(457);
                            if (p.thanhvien == 1) {
                            ...
                            Service.gI().updateItemBag(p);
                            Service.gI().buyDone(p);
                            p.sendAddchatYellow("Kích hoạt thành công phần quà tặng thêm là x10 Thỏi Vàng");
                            return;
                            ...
                            Service.chatNPC(p, (short) p.menuNPCID, "|7|Bảng Giá Nạp Vàng\b|1|20.000 = 50 Thỏi Vàng\b|1|50.000 = 110 Thỏi Vàng\b|1|100.000 = 240 Thỏi Vàng\b|1|200.000 = 550 Thỏi Vàng\b|1|500.000 = 1200 Thỏi Vàng\b|1|1.000.000 = 2800 Thỏi Vàng\n|7|Bảng Giá Nạp Ngọc\b|1|20.000 = 20K Ngọc xanh\b|1|50.000 = 50K Ngọc xanh\b|1|100.000 = 110K Ngọc xanh\b|1|200.000 = 250K Ngọc xanh\b|1|500.000 = 550K Ngọc xanh\b|1|1.000.000 = 1M2 Ngọc xanh\n|7|Thông Tin Chuyển Khoản\b|1|MOMO: 082.942.6595\b|1|BIDV: 53110001063699\b|2|Lưu Ý : Chuyển khoản nhắn tin Zalo trước");
                            return;
                        } else if (p.menuID == 3 && select == 0) {
                            if (p.nhanqua >= 1) {
                                p.sendAddchatYellow("Sự kiện đã kết thúc bạn không thể nhận quà!");
                                return;
                            } else if (p.getBagNull() <= 0) {
                                p.sendAddchatYellow("Hành trang không đủ chỗ trống!");
                                return;
                            }
                            p.nhanqua = 1;//Giang sinh
                            p.ngoc += 0;
                            Item itemBuff = ItemBuff.getItem(457);
                            Item _itemBuff = new Item(itemBuff);
                            _itemBuff.quantity = 0;
                            p.addItemToBag(_itemBuff);
                            Service.gI().updateItemBag(p);
                            Service.gI().buyDone(p);
                            p.sendAddchatYellow("Sự kiện đã kết thúc bạn không thể nhận quà!");
                    ...
                    if (select == 0) {
                        ...
                        doMenuArray(p, idNpc, "|2|Ngươi muốn kích hoạt thành viên ư ?\b|1|Phí kích hoạt sẽ là: 0 Robux\b|7|Số Robux hiện có: " + p.sotien, new String[]{"Kích Hoạt", "Từ Chối"});
                        p.menuID = select;
                        break;
                    } else if (select == 2) {
                        ...
                        doMenuArray(p, idNpc, "|2|Nhân ngày giáng sinh thằng Admin chúc các bạn\n|2|Có 1 ngày vui vẻ và thật nhiều hạnh phúc <3\n|7|Bên dưới là món quà mà Admin không muốn gửi đến bạn\n|1|Chúc các bạn chơi game không vui vẻ", new String[]{"Nhận Quà\nGiáng Sinh", "Từ Chối"});
                        p.menuID = select;
                        break;
                    }
                }
            ...
            case 37: {
                if (p.map.id == 102) {
                    if (p.menuID == -1) {
                        if (select == 0) {
                            Service.chatNPC(p, (short) p.menuNPCID, "chào, Website tải game bạn biêt chưa!");
                            break;
                        } else if (select == 1) {
...
//                        p.LOADCAITRANGTOME();
//                    } 
                    else if (select == 1) { // DOI SKILL 2
                        if (p.havePet == 1 && (p.detu.power >= 150000000L)) {
                            if(p.detu.isBerus){
                                p.sendAddchatYellow("Bạn không thể đổi skill đệ Berus");
                                Service.gI().endEffCallDragon(p);
                                return;
                                
                            }
                            int rdSkill2 = Util.nextInt(0, 1);
                            if (rdSkill2 == 0) {
                    ...
                    } else if (select == 2) {// Đổi skill 3 đệ
                        if (p.havePet == 1 && (p.detu.power >= 1500000000L)) {
                            if(p.detu.isBerus){// Check đệ Berus
                                p.sendAddchatYellow("Bạn không thể đổi skill đệ Berus");
                                Service.gI().endEffCallDragon(p);
                                return;
                            }
                            int rdSkill2 = Util.nextInt(0, 5);
...
//                        }
//                    } 
//                    else if (select == 5) { //GANG TAY DE TU DANG MANG LEN 1 CAP
...
//                    } 
                        ...
                        p.critNr = (byte) (p.critNr + 2) > (byte) 20 ? (byte) 20 : (byte) (p.critNr + 2);
                        Service.gI().loadPoint(p.session, p);
                    } else if (select == 5) { // Điều ước ngọc
                        p.ngoc += (long) 3200;
                        Service.gI().buyDone(p);
                        //break;
                    }
...
//                        }
                ...
                if (p.map.id == 48) {
                    if (p.menuID != -1) {
                        if (p.menuID == 2 && select == 0) { //CON DUONG RAN DOC
                            ...
                            Service.chatNPC(p, (short) p.menuNPCID, "Hiện tại, map chưa được hoàn thiện dragon đang mở để cho các bạn trải nghiệm!");
                            break;
                        }
                    }
                    if (select == 0) {
            ...
            case 18: { //THAN MEO
                if (p.map.id == 46) {
                    ...
                    if (select == 0) {
                        Service.chatNPC(p, (short) p.menuNPCID, "dragon, là tên máy chủ chắc không cần nhắc thì con cũng biết là trang chủ dragon.vn nhỉ ?");
                        p.menuID = select;
                    }
                }
                break;
            ...
            case 19: { //THUONG DE
                ...
                if (p.map.id == 141) {
                    ...
                    if (select == 0) {
                        Service.chatNPC(p, (short) p.menuNPCID, "Hiện tại dragon chưa hoàn thiện xong map này vui lòng quay lại sau..!");
                    }
                    if (select == 1) {
                        p.zone.goMapTransport(p, 48);
                    }
...
//                            Service.chatNPC(p, (short) 24, HelperDAO.getTopCard());
                            ...
                            if (Server.gI().isServer == (byte) 1) {
                                ...
                                p.sendAddchatYellow("Chỉ thực hiện tại dragon oke 01");
                            }
                            break;
                            ...
                            Service.chatNPC(p, (short) p.menuNPCID, "Hiện tại kho báu dưới biển chưa hoàn thiện dragon chỉ mở để cho các bạn trải nghiệm map này!");
                            break;
                        }
                    }
                    if (select == 0) {
            ...
            case 2: {
                if (p.map.id == 22) {
                    if (p.menuID == -1) {
                        ...
                        if (select == 1) {
                            long _vang = ((long) p.vang + 0) > 2000000000L ? 2000000000L : ((long) p.vang + 0);
                            p.vang = _vang;
                            Service.gI().buyDone(p);
                            p.sendAddchatYellow("Nhận thành công 500 triệu cái nịt");
                            break;
                        }
                        if (select == 2) {
                            if (p.ngoc < 10000000) {
                                p.ngoc = p.ngoc + 0;
                                Service.gI().buyDone(p);
                                p.sendAddchatYellow("Nhận thành công 100k cái nịt");
                            } else {
...
//         System.out.println("select: "+ select);
    ...
    public void openUINpc(Player p, Message m) throws IOException {
        ...
        if (p.menuNPCID == 74 && p.map.id == 5) {
            ...
            if (p.map.id == 5) {
                doMenuArray(p, idnpc, "Bố mẹ ở nhà thì còng lưng nuôi đi ăn đi học, Yêu với đương cái gì ?", new String[]{"Đổi Đệ Tử", "Đổi SôCôLa", "Từ chối"});
            }
            return;
            ...
            doMenuArray(p, idnpc, "admin tặng bạn nịt", new String[]{"Nói Chuyện", "Từ Chối"});
            return;
...
//                doMenuArray(p,idnpc,Text.get(0, 1),new String[]{"Cửa Hàng"});
            ...
            if ((p.menuNPCID == 0 && p.map.id == 21) || (p.menuNPCID == 1 && p.map.id == 23) || (p.menuNPCID == 2 && p.map.id == 22)) {
                if (p.crrTask.subtasks[(byte) (p.crrTask.countSub - (byte) 1)] == (byte) p.menuNPCID && p.crrTask.index == (byte) (p.crrTask.countSub - (byte) 1)) {
                    ...
                    p.UpdateSMTN((byte) 2, p.crrTask.bonus);
//                    long _vang = ((long) p.vang + 1500000000) > 2000000000L ? 2000000000L : ((long) p.vang + 1500000000);
//                    p.vang = _vang;
//                    p.ngoc += 10000;              
                    Service.gI().buyDone(p);
                    p.sendAddchatYellow("Bạn vừa được thưởng " + Util.powerToString(p.crrTask.bonus) + " sức mạnh");
                ...
                if (p.hasTrungMabu) {
                    doMenuArray(p, idnpc, Text.get(0, 0), new String[]{"Nhập Giftcode", "Đệ Tử\nMabư"});
                } else {
                    doMenuArray(p, idnpc, Text.get(0, 0), new String[]{"Nhập Giftcode"});
                }
            }
            return;
